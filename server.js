...
function CheckCode(codeType, codeFile, answers){
	...
	for (var i=0; i<answers.length; i++){
		...
		try {
			...
			codeAnswer = child_process.execSync("ulimit -m 16; ulimit -v 16; ulimit -H -v; "+execCommand + " ./uploads/" + codeFile + " < " + "./" +inputFile.replace('\\', '/'),{timeout: 10000, shell: '/bin/bash'}).toString();
